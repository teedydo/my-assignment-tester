...
{		
	...
	public void onTestStart(ITestResult result) {		
		...
		context.setAttribute("testMethodName", testMethodName);
	...
	private void takeScreenshot(ITestResult result) {
        ...
        takeScreenshot(testMethodName + "_" + MyDateUtils.getCurrentTimeString(),driver);
		log.info("TAKE-SCREENSHOT-AFTER-METHOD");
	}
}		
